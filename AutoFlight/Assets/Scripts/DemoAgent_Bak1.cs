...
public class DemoAgent_Bak1 : Agent
{
    ...
    public override void OnEpisodeBegin()
    {
        ...
        tfAgent.localPosition = new Vector3(250.0f, 0.0f, 0.0f);
        tfTarget.localPosition = new Vector3(Random.Range(-200f, 250f), Random.Range(25f, 100f), Random.Range(-200f, 200f));
